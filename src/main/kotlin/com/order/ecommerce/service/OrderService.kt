...
class OrderService(
    ...
    fun OrderDto.toOrderEntity(orderId: String) = Order(
        ...
        payment = paymentsService.buildAndLoadPayment(amount, paymentMode),
        billingAddress = addressService.buildAndLoadAddress(billingAddress),
        shippingAddress = addressService.buildAndLoadAddress(shippingAddress),
        orderItems = null
